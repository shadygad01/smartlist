> ## ⚠️ تحذير — هذا التقرير غير صالح كدليل أداء
> المراجعة الكمية المستقلة (انظر `INDEPENDENT_AUDIT_AR.md`) أثبتت أن الأرقام
> الرئيسية هنا (CAGR 958%، MDD −0.20%، PF 55، تحليل عتبات r1) ناتجة عن:
> (1) خروج افتراضي عند **قمة** الـ15 يوم المستقبلية، (2) محاكاة عتبات r1 عبر
> **الفلترة على العائد المحقق نفسه** (دائرية كاملة)، (3) تجاهل قيد رأس المال
> (تعرض متزامن ضمني حتى 378%). الأرقام الصادقة لنفس البيانات: متوسط عائد
> +3.0% لكل حدث، Profit Factor ≈ 2.4، و40.6% من الأحداث سالبة على أساس
> close-to-close. لا تُستخدم أرقام هذا الملف في أي قرار معايرة أو تخصيص رأس مال.
