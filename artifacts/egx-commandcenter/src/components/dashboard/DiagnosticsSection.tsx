    ...
    <div className="rounded-xl" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)', boxShadow: '0 2px 16px rgba(0,0,0,0.3)' }}>
      ...
      >
        <div className="flex items-center gap-2">
          <Activity
            size={13}
            style={{ color: overallStatus === 'healthy' ? 'var(--signal-buy)' : overallStatus === 'error' ? '#ef4444' : 'var(--muted-foreground)' }}
          />
          ...
          {snapshot && (
            <>
              ...
              {lineage?.source_fingerprints && (
                <div className="px-3 py-2.5 rounded-xl" style={{ backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-subtle)' }}>
