...
export default function ValuationPanel({
  ...
  return (
    <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', backgroundColor: 'rgba(80,216,208,0.03)' }}>
      <button
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono font-bold" style={{ fontSize: '9px', color: upsideColor }}>
            {upside}
          </span>
        </div>
        {collapsed
