...
def _section_research_lab() -> str:
    """Research Knowledge Layer — delegates to _research_lab_section for clean code."""
    try:
        from research_features import get_dashboard_data
        from _research_lab_section import build_research_lab_section
        data = get_dashboard_data()
        return build_research_lab_section(
            data=data,
        ...
        return (
            ...
            + _section_header("RESEARCH LAB", "🧪")
            + '<p style="color:' + R + '">Research module unavailable: ' + str(_e) + '</p></div>'
        )
